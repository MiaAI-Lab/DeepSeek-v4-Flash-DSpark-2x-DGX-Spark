...
class OpenAIServingChat(GenerateBaseServing):
            ...
            async for res in result_generator:
                ...
                for output in res.outputs:
                    ...
                    # if the model is finished generating
                        ...
                        # [issue55-hotfix] tool-call truncation safety gate the tool_calls verdict on engine length,
    ...
    async def chat_completion_full_generator(
        ...
        for output in final_res.outputs:
            ...
            # [issue55-hotfix] tool-call truncation safety if the engine truncated for length, do not
