...
class NetworkTemplatesTest(unittest.TestCase):
    ...
    def test_nccl_image_is_immutable(self):
        ...
        self.assertIn("OPENMPI_VERSION=4.1.6", dockerfile)
        self.assertIn("44da277b8cdc234e71c62473305a09d63f4dcca292ca40335aab7c4bf0e6a566", dockerfile)
        self.assertIn("MPI_HOME=/opt/openmpi", dockerfile)
        self.assertIn("--with-pmix=internal", dockerfile)
